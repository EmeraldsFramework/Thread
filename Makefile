...
test:
	$(CC) $(OPT) $(VERSION) $(HEADERS) $(FLAGS) $(WARNINGS) $(REMOVE_WARNINGS) $(UNUSED_WARNINGS) -Wno-implicit-function-declaration $(LIBS) -o $(TESTOUTPUT) $(shell find ./libs -name "*.*o") $(TESTFILES) $(TESTINPUT)
	@echo
	./$(TESTOUTPUT)
